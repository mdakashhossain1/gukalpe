...
@php
    $navItems = [
        ...
        ['route' => 'admin.withdrawal-settings', 'key' => 'withdrawal-settings', 'icon' => 'fa-money-check-dollar', 'label' => 'Withdrawal settings'],
        ['route' => 'admin.logs', 'key' => 'logs', 'icon' => 'fa-list', 'label' => 'Activity logs'],
        ['route' => 'admin.audit-log', 'key' => 'audit-log', 'icon' => 'fa-shield-halved', 'label' => 'Audit log'],
    ...
    $navPerms = [
        ...
        'withdrawal-settings' => 'manage_settings',
