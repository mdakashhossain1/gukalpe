...
@section('content')
    ...
    <div class="h-screen flex flex-col bg-white overflow-hidden">
        ...
        <div class="shrink-0 bg-white border-t border-slate-100 px-6 pt-4 pb-6">
            <button type="submit" form="forgot-mpin-form" data-loading-text="Sending OTP..." class="btn-shimmer-cta w-full h-[56px] rounded-full bg-[#0A5C66] text-white font-bold text-[16px] hover:bg-[#0E7481] active:scale-[0.98] transition-all flex items-center justify-center gap-2">
