...
<div class="flex flex-col md:flex-row min-h-screen">
    ...
    <main class="flex-1 min-w-0 flex flex-col min-h-screen">
        ...
        <p class="text-[13.5px] text-[#64748B] mb-6">Shown at random among all active bank accounts whenever the deposit amount falls in the Bank amount range (set on the Payment gateway page).</p>
